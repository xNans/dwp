...
<?php $page_title = 'Rediger sider';?>
<?php include(SHARED_PATH . '/admin_header.php') ?>

<div id="content">
    <a class ="back-link" href="<?php echo url_for('/admin/pages/index.php'); ?>">&laquo; Tilbage til sider</a>

    <div class="page edit"><h1>Rediger side</h1>
